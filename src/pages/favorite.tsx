...
const Favorites = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-black text-white px-5 md:px-16 pt-32 flex flex-col items-center">
              ...
              >
                ...
                <div className="flex-1 flex flex-col justify-start gap-7">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    >
                      <img
                        src="/assets/favorite/heart-filled.svg"
                        alt="Remove favorite"
